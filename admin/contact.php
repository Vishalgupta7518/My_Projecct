    ...
    <div class="row">
        <!-- <div class="col-lg-2 bg-dark" style="height: 100vh;">
          <nav class="navbar navbar-light">
            ...
            <li class="nav-item">
                <a href="#" class="nav-link text-light text-uppercase font-weight-bold py-4">Contact</a>
            </li>
            <li class="nav-item">
        ...
        <div class="col-lg-10 ">
         <div class="container-fluid p-5">
          ...
          <table class="mb-3 table table-bordered table-striped text-center">
            <h1 class="my-3 text-center"><b>Contact</b></h1>
            <thead class="table-dark">
            <tr>
                <th>Sr.n</th>
                <th>Name</th>
                <th>Email<i class="fas fa-envelope fa-2x mx-3 text-primary"></i></th>
                <th>Massage<i class="fa fa-comment fa-2x mx-3 text-primary"></i></th>
                <th>Delete</th>
            </tr>
            </thead>
            <tbody>
