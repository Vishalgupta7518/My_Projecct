    ...
    <div class="row">
        <!-- <div class="col-lg-2 bg-dark" style="height: 100vh;">
          <nav class="navbar navbar-light">
            ...
            <li class="nav-item">
                <a href="#" class="nav-link text-light text-uppercase font-weight-bold py-4">Project</a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
               <a href="../index.php" class="nav-link text-light text-uppercase font-weight-bold py-4" >Logout</a>
            </li>
            </ul>
          </nav>
        </div> -->
        ...
        <div class="col-lg-10 ">
         <div class="container-fluid p-5">
          ...
          <table class="mb-3 table table-bordered table-striped text-center">
            <h1 class="my-3 text-center"><b>Project</b></h1>
            <?php
              addProject();
            ?>
